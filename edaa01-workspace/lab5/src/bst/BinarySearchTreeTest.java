...
class BinarySearchTreeTest {
	...
	void tearDown() throws Exception {
		myIntBinarySearchTree = null;
		myStringBinarySearchTree = null;
	}
	...
	void testAddDuplicatesString() {
		assertTrue(myStringBinarySearchTree.add("Hej"));
		assertFalse(myStringBinarySearchTree.add("Hej"));
	}
	...
	void testAddString() {
		...
		System.out.println("Utskrift av strängar inorder");
